  ...
  const ChecklistEmptyState = () => (
    <View style={styles.emptyState}>
      <View style={styles.emptyIcon}>
        <MaterialIcons name="check-box" size={60} color="#EC4899" />
      </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem}>
          <MaterialIcons name="home" size={24} color="#EC4899" />
          <Text style={[styles.navText, { color: "#EC4899" }]}>Home</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <MaterialIcons name="assignment" size={24} color="#9CA3AF" />
          <Text style={styles.navText}>My Promises</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
          <MaterialIcons name="subscriptions" size={24} color="#9CA3AF" />
